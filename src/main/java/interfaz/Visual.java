...
import conexion.Con_PostgreSQL;
import conexion.Con_SQLServer;
...
public class Visual extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        SQLServ = new javax.swing.JRadioButton();
    ...
    private void SQLServActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SQLServActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_SQLServActionPerformed

    private void conexActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_conexActionPerformed
        if(SQLServ.isSelected()){
            Con_SQLServer.getConnection(Host.getText(), NomBD.getText(), User.getText(), Pass.getText());
        }else{
            if(PostgreSQL.isSelected()){
                Con_PostgreSQL.getConPostgreSQL(Host.getText(), NomBD.getText(), User.getText(), Pass.getText());
            }
        }
